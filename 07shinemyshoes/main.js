...
function video1(){
    vid.style.opacity = "1";
    poem.innerHTML = "this one makes me giddy";
...
function video2(){
    vid.src = "assets/shinemyshoes02.mp4";
    vid.style.opacity = "1";
    poem.style.opacity = "1";
    poem.innerHTML = "i mean i can hardly catch my breath";
    track.style.opacity = "0";
    heading.style.opacity = "0";
    navOff();
}
...
function video3(){
    vid.src = "assets/shinemyshoes03.mp4";
    vid.style.opacity = "1";
    poem.style.opacity = "1";
    poem.innerHTML = "and i can feel the sweat dripping";
    track.style.opacity = "0";
    heading.style.opacity = "0";
    navOff();
}
...
function video4(){
    vid.src = "assets/shinemyshoes04.mp4";
    vid.style.opacity = "1";
    poem.style.opacity = "1";
    poem.innerHTML = "thank you for the towel by the way";
    track.style.opacity = "0";
    heading.style.opacity = "0";
    navOff();
}
...
function video5(){
    vid.src = "assets/shinemyshoes05.mp4";
    vid.style.opacity = "1";
    poem.style.opacity = "1";
    poem.innerHTML = "but my beating heart isn't scary";
    track.style.opacity = "0";
    heading.style.opacity = "0";
    navOff();
}
...
function video6(){
    vid.src = "assets/shinemyshoes06.mp4";
    vid.style.opacity = "1";
    poem.style.opacity = "1";
    poem.innerHTML = "it's a sign of joyful ability";
    track.style.opacity = "0";
    heading.style.opacity = "0";
    navOff();
}
...
function video7(){
    vid.src = "assets/shinemyshoes07.mp4";
    vid.style.opacity = "1";
    poem.style.opacity = "1";
    poem.innerHTML = "rather than alarming inability";
    track.style.opacity = "0";
    heading.style.opacity = "0";
    navOff();
}
...
function video8(){
    vid.src = "assets/shinemyshoes08.mp4";
    vid.style.opacity = "1";
    poem.style.opacity = "1";
    poem.innerHTML = "like you, i will dance this forever";
    track.style.opacity = "0";
    heading.style.opacity = "0";
    navOff();
}
